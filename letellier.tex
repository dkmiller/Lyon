...
\thanksauthor{Emmanuel Letellier}
...
\begin{theo}[Lascoux-Sch\"utzenberger, Lusztig]
...
\subsection{The character table of \texorpdfstring{$\generallinear_n(\dF_q)$}{GLnFq}}
...
\subsubsection{Connection with cohomology}
...
\begin{theo}[Beilinson, Bernstein, Deligne, Gabber]
...
\begin{theo}[special case of the decomposition theorem]
...
\subsubsection{Induction picture for \texorpdfstring{$L=T$}{L=T}}
